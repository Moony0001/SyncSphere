...
// Raised limits so base64 image payloads (profile pics, club logos, and the
// activity route snapshot) don't hit the default 100kb cap and 413.
app.use(express.json({ limit: "10mb" }));
app.use(express.urlencoded({ extended: true, limit: "10mb" })); // parse rich URL-encoded bodies
